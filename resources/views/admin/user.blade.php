                                        ...
                                        @foreach ($user as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    &nbsp; &nbsp;
                                                    <a href="{{ url('admin/add-edit-user', $user->id) }}" data-bs-toggle="modal"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form  id="subadminForm" action="{{ url('admin/update-user', $user->id) }}"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <input disabled=""
                                                                        value="{{ $user->email }}"
                                                                            style="background-color: #666666" type="email"
